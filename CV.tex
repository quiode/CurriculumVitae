...
\address{\url{https://dominik-schwaiger.ch}}
\address{Hofackerstrasse 3, 8722 Kaltbrunn} % Your address
\address{(+41) 78 746 68 28 \\ mail@dominik-schwaiger.ch} % Your phone number and email
\image{avatar} % Image in the CV

\begin{document}
% link source
\blfootnote{Quelle: \url{https://github.com/quiode/CurriculumVitae}}
% Creation Date of Document as Footnote
\blfootnote{Version vom \today}
